...
namespace AssetBundles
{
    ...
    public class AssetBundleManager : MonoBehaviour
    {
        ...
        static Dictionary<string, float> m_LoadedAssetBundlesProgress = new Dictionary<string, float>();
        ...
        static public AssetBundleLoadManifestOperation Initialize(string manifestAssetBundleName)
        {
            ...
            m_LoadedAssetBundlesProgress.Clear();
        ...
        public static float GetAssetBundleProgress(string assetBundleName)
        {
            return (m_LoadedAssetBundlesProgress.ContainsKey(assetBundleName)) ? m_LoadedAssetBundlesProgress[assetBundleName] : 0f;
        }
        ...
        static protected void UnloadAssetBundleInternal(string assetBundleName)
        {
            ...
            if (--bundle.m_ReferencedCount == 0)
            {
                ...
                m_LoadedAssetBundlesProgress.Remove(assetBundleName);
        ...
        void ProcessUpdateOperation(AssetBundleLoadOperation operation)
        {
            AssetBundleDownloadOperation download = operation as AssetBundleDownloadOperation;
            if (download == null)
                return;

            if (!m_LoadedAssetBundlesProgress.ContainsKey(download.assetBundleName))
                m_LoadedAssetBundlesProgress.Add(download.assetBundleName, 0f);
            m_LoadedAssetBundlesProgress[download.assetBundleName] = download.Progress;
        }
        ...
        void ProcessFinishedOperation(AssetBundleLoadOperation operation)
        {
            ...
            if (string.IsNullOrEmpty(download.error))
            {
                ...
                m_LoadedAssetBundlesProgress[download.assetBundleName] = 1f;
            }
            else
            {
