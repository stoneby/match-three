...
namespace qy
{
    public class GuideManager : MonoBehaviour
    {
        ...
        {
            if (PlayerPrefs.GetInt(string.Format("{0}_{1}", PlayerPrefEnums.IsChapterGuideComplete, GameMainManager.Instance.Chapter)) > 0)
                return;
        ...
        {
            //特殊处理 结束引导时的处理
            PlayerPrefs.SetInt(string.Format("{0}_{1}", PlayerPrefEnums.IsChapterGuideComplete, GameMainManager.Instance.Chapter), 1);
        }
