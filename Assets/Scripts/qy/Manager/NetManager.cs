...
namespace qy.net
{
    ...
    public class NetManager:MonoBehaviour
    {
        ...
        private Queue<Dictionary<string, object>> bufferQueue = new Queue<Dictionary<string, object>>();//缓存数据队列
        private Queue<Action> queue = new Queue<Action>();//缓存请求队列
